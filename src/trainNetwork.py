...
def trainNetwork(Qnet, training_matches, validation_matches, train_epochs, batch_size, buffer_size, spinup_epochs = 0, load_model = False, verbose = False):
    """
    Args:
        ...
        spinup_epochs (int): number of epochs to 'spin up' model, reducing spurious predictions
    ...
    if(verbose):
        ...
        print("  spinup_epochs: {}".format(spinup_epochs))
    ...
    lr_decay_freq = 500 # Decay learning rate after a set number of epochs
    ...
    with tf.Session() as sess:
        ...
        for i in range(train_epochs):
            ...
            if((i>0) and (i % lr_decay_freq == 0)):
                ...
                #Qnet.learning_rate = Qnet.learning_rate
                Qnet.learning_rate = Qnet.learning_rate/2.
            ...
            for match in shuffled_matches:
                ...
                for experience in experiences:
                    ...
                    if state_code in DraftState.invalid_states:
                        # If prediction moves to illegal state, add negative experience
                        ...
                        # submission from training example. This follows the "epsilon-greedy" approach
            ...
            t1 = time.time()-t0
            _,val_acc = validate_model(sess, validation_matches, Qnet)
            ...
            if(verbose):
                print(" Finished epoch {}/{}: dt {:.2f}, mem {}, loss {:.6f}, train {:.6f}, val {:.6f}".format(i+1,train_epochs,t1,total_steps+null_action_count,loss,train_acc,val_acc))
